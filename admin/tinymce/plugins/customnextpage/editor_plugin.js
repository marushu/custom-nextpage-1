    ...
    tinymce.create('tinymce.plugins.CustomNextpage', {
        ...
        init: function (ed, url) {
            ...
            image =
                '<img src="' +
                url +
                '/img/custom-next-page.png" class="custom-next-tag mceItemNoResize" alt="" /><br>';
            shortCode = '[nextpage]';
            ...
            ed.onBeforeSetContent.add(function (ed, o) {
                if (o.content) o.content = t._do_code(o.content, image);
            });

            // Replace images with nextpage
            ed.onPostProcess.add(function (ed, o) {
                if (o.get) o.content = t._get_code(o.content, shortCode);
            });

            ed.addButton('customnextpage', {
                cmd: 'customnextpage_cmd',
                title: ed.getLang(
                    'customnextpage.buttonTitle',
            ...
            ed.onNodeChange.add(function (ed, cm, n) {
                cm.setActive(
                    'customnextpage',
                    n.nodeName === 'IMG' &&
                        ed.dom.hasClass(n, 'custom-next-tag')
                );
            });
        },
        ...
        keydown: function (event) {
            var ed = tinyMCEPopup.editor,
                fn,
                key = $.ui.keyCode;
            if (event.which !== key.ESCAPE) return;
